...
export function EditProductDialog() {
  const { dialogType, selectedProduct, closeDialog, updateProduct, loading } = ProductsContainer.useContainer();
  ...
  const handleInputChange = (field: keyof UpdateProductRequest) => (
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title="Edit Product" size="md">
      <form onSubmit={handleSubmit} className="p-[22px]">
        <div className="space-y-[18px]">
          {/* Product Name */}
          <div>
            <label htmlFor="edit-name" className="block text-[12px] font-medium text-black mb-[2px]">
              Product Name
            </label>
            <input
              type="text"
          ...
          {/* Description */}
          <div>
            <label htmlFor="edit-description" className="block text-[12px] font-medium text-black mb-[2px]">
              Description
            </label>
            <textarea
              id="edit-description"
          ...
          <div className="grid grid-cols-2 gap-[13px]">
            {/* Price */}
            <div>
              <label htmlFor="edit-price" className="block text-[12px] font-medium text-black mb-[2px]">
                Price ($)
              </label>
              <input
                type="number"
            ...
            {/* Stock */}
            <div>
              <label htmlFor="edit-stock" className="block text-[12px] font-medium text-black mb-[2px]">
                Stock
              </label>
              <input
                type="number"
